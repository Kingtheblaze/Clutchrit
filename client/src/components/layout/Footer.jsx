      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-16 relative z-10">
        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/clutchrit.esports?igsh=MXgzdWNoc3g2MXU5Yw==" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-surface-1 border border-border flex items-center justify-center text-text-1 hover:bg-fire hover:text-void hover:border-fire transition-all duration-300">
              <FaInstagram size={20} />
            </a>
